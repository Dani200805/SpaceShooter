...
export function createEnemies(count, canvasWidth, enemySize, enemyImage) {
	...
	for (let i = 0; i < count; i++) {
		...
		enemies.push(new Enemy(x, y, enemySize, enemySize, color, speed, enemyImage))
	}
...
export function createPowerUp(canvasWidth, powerUpSize, powerUpImages) {
	...
	return new PowerUp(x, y, powerUpSize, type, speed, image)
}
